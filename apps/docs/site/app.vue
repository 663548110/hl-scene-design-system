<template>
  <td-doc-layout>
    ...
    <td-theme-generator></td-theme-generator>
  </td-doc-layout>
</template>
...
export default defineComponent({
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      const headerEl = document.querySelector('td-header');
      const headerShadow = headerEl?.shadowRoot;
      if (headerShadow) {
        injectStyle(headerShadow, `
          .TDesign-header-left { display: none !important; }
          a.TDesign-header-nav__link { display: none !important; }
          .TDesign-header-nav__git { display: none !important; }
          .TDesign-header-nav__translate { display: none !important; }
        `);
      }
    });
