...
具体代码请参考 [深色模式切换](https://github.com/Tencent/rdesign-flutter/blob/develop/rdesign-component/example/lib/component_test/dark_test.dart)。
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /// 具体可参考 rdesign-flutter/rdesign-component/example/lib/component_test/dark_test.dart
    return MaterialApp(
      title: '深色模式切换测试',
