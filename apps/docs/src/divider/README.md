...
[td_divider_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_divider_page.dart)
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          RDText('文字信息', textColor: RDTheme.of(context).textColorPlaceholder),
          const RDDivider(
            width: 0.5,
            height: 12,
            margin: EdgeInsets.symmetric(horizontal: 8),
