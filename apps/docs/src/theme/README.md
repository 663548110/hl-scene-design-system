...
| extraThemeData | RDExtraThemeData? | - | 额外定义的结构 |
...
| 名称 | 返回类型 | 参数 | 说明 |
| --- | --- | --- | --- |
| defaultData |  |   RDExtraThemeData? extraThemeData, | 获取默认Data，一个App里只有一个，用于没有context的地方 |
| fromJson |  |   required String name,  required String themeJson,  null recoverDefault,  RDExtraThemeData? extraThemeData, | 解析配置的json文件为主题数据 |
