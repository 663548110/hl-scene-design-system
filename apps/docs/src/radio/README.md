...
[td_radio_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_radio_page.dart)
...
<td-code-block panel="Dart">
  ...
  Widget _verticalRadios(BuildContext context) {
    return RDCell(
      ...
      hover: false,
      required: true,
      descriptionWidget: RDRadioGroup(
        selectId: '0',
...
<td-code-block panel="Dart">
  ...
  Widget _horizontalRadiosWrap(BuildContext context) {
    return RDRadioGroup(
      ...
      rowCount: 4,
      directionalTdRadios: const [
        RDRadio(id: '0', title: '单0'),
        RDRadio(id: '1', title: '单1'),
        RDRadio(id: '3', title: '单2'),
        RDRadio(id: '4', title: '单3'),
        RDRadio(id: '5', title: '单4'),
        RDRadio(id: '6', title: '单5'),
      ],
    );
  }</pre>
...
<td-code-block panel="Dart">
  ...
  Widget _checkStyle(BuildContext context) {
    return Column(
      children: [
        RDRadioGroup(
          radioCheckStyle: RDRadioStyle.check,
          selectId: 'index:0',
          child: const RDRadio(
            id: 'index:0',
            title: '单选',
        ...
        RDRadioGroup(
          radioCheckStyle: RDRadioStyle.hollowCircle,
          selectId: 'index:0',
          child: const RDRadio(
            id: 'index:0',
            title: '单选',
...
| insetSpacing |  | - |  |
| key |  | - |  |
| radioStyle | RDRadioStyle | RDRadioStyle.circle | 单选框按钮样式 |
| selectColor |  | - |  |
| showDivider | bool | - | 是否显示下划线 |
| size |  | RDCheckBoxSize.small |  |
| spacing |  | - |  |
| subTitle |  | - |  |
| subTitleColor |  | - |  |
| subTitleFont |  | - |  |
...
| onRadioGroupChange |  | - |  |
| passThrough |  | - |  |
| radioCheckStyle | RDRadioStyle? | - | 勾选样式 |
| rowCount | int | 1 | 每行几列 |
| selectId |  | - |  |
