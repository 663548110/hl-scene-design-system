...
[td_popup_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_popup_page.dart)
              ...
              builder: (context) {
                return Container(
                  decoration: BoxDecoration(
                    color: RDTheme.of(context).bgColorContainer,
                    borderRadius:
                        BorderRadius.circular(RDTheme.of(context).radiusLarge),
                  ),
                  width: 240,
                  height: 240,
                );
      ...
      onTap: () {
        Navigator.of(context).push(
          RDSlidePopupRoute(
            slideTransitionFrom: SlideTransitionFrom.bottom,
            builder: (context) {
              return RDPopupBottomConfirmPanel(
                title: '标题文字',
                leftClick: () {
                  Navigator.maybePop(context);
                },
                rightClick: () {
                  RDToast.showText('确定', context: context);
                  Navigator.maybePop(context);
                },
...
<td-code-block panel="Dart">
  ...
  Widget _buildPopFromBottomWithOperation(BuildContext context) {
    return RDButton(
      ...
      size: RDButtonSize.large,
      onTap: () {
        Navigator.of(context).push(RDSlidePopupRoute(
            modalBarrierColor: RDTheme.of(context).fontGyColor2,
            slideTransitionFrom: SlideTransitionFrom.bottom,
            builder: (context) {
              return RDPopupBottomConfirmPanel(
                leftClick: () {
      ...
      onTap: () {
        Navigator.of(context).push(
          RDSlidePopupRoute(
              slideTransitionFrom: SlideTransitionFrom.bottom,
              builder: (context) {
                return RDPopupBottomDisplayPanel(
                  title: '标题文字',
                  closeClick: () {
                    Navigator.maybePop(context);
                  },
