...
[td_cascader_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_cascader_page.dart)
...
| 参数 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| action | RDCascaderAction? | - | 自定义选择器右上角按钮 |
