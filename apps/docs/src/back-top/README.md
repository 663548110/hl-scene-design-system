...
[td_backtop_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_backtop_page.dart)
      ...
      children: [
        getCustomButton(context, '半圆形返回顶部', () {
          setState(() {
            ...
            style = RDBackTopStyle.halfCircle;
          });
        }),
        Padding(
...
| style | RDBackTopStyle | RDBackTopStyle.circle | 样式，圆形和半圆 |
| theme | RDBackTopTheme | RDBackTopTheme.light | 主题 |
