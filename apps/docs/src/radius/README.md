  ...
  Widget _buildRadiusSmall(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(RDTheme.of(context).radiusSmall)),
    );
  }</pre>
...
<td-code-block panel="Dart">
  ...
  Widget _buildRadiusLarge(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: RDTheme.of(context).brandNormalColor,
          borderRadius: BorderRadius.circular(RDTheme.of(context).radiusLarge)),
    );
  }</pre>
...
<td-code-block panel="Dart">
  ...
  Widget _buildRadiusRound(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: RDTheme.of(context).brandNormalColor,
          borderRadius: BorderRadius.circular(RDTheme.of(context).radiusRound)),
    );
  }</pre>
  ...
  Widget _buildRadiusCircle(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: RDTheme.of(context).brandNormalColor,
          borderRadius:
              BorderRadius.circular(RDTheme.of(context).radiusCircle)),
    );
  }</pre>
...
## API
### radius
RDTheme内置radiusXXX系列参数，可参考radius演示代码实现圆角组件
