...
[td_avatar_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_avatar_page.dart)
...
<td-code-block panel="Dart">
  ...
  Widget _buildImageAvatar(BuildContext context) {
    return const Row(
      ...
      children: [
        RDAvatar(
          size: RDAvatarSize.medium,
          type: RDAvatarType.normal,
      ...
      children: [
        SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(child: RDBadge(RDBadgeType.redPoint), right: 0, top: 0)
            ],
          ),
        ),
        SizedBox(width: 32),
        SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                child: RDBadge(RDBadgeType.message, count: '8'),
                right: 0,
                top: 0,
              )
            ],
        ...
        SizedBox(
          ...
          child: Stack(
            alignment: Alignment.bottomLeft,
            children: [
              RDAvatar(size: RDAvatarSize.medium, type: RDAvatarType.icon),
              Positioned(
                child: RDBadge(RDBadgeType.message, count: '12'),
                right: 0,
                top: 0,
              )
            ],
...
<td-code-block panel="Dart">
  ...
  Widget _buildOperationAvatar(BuildContext context) {
    ...
    return RDAvatar(
      size: RDAvatarSize.medium,
      type: RDAvatarType.operation,
      avatarDisplayListAsset: avatarList,
      onTap: () {
        RDToast.showText('点击了操作', context: context);
      },
    );
  }</pre>
...
| radius | double? | - | 自定义圆角 |
| shape | RDAvatarShape | RDAvatarShape.circle | 头像形状 |
| size | RDAvatarSize | RDAvatarSize.medium | 头像尺寸 |
| text | String? | - | 自定义文字 |
| type | RDAvatarType | RDAvatarType.normal | 头像类型 |
