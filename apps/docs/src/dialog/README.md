...
[td_dialog_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_dialog_page.dart)
        ...
        showGeneralDialog(
          ...
          pageBuilder: (BuildContext buildContext, Animation<double> animation,
            ...
            return RDImageDialog(
              ...
              title: _dialogTitle,
              content: _commonContent,
              imagePosition: RDDialogImagePosition.middle,
            );
          },
        );
      },
        ...
        showGeneralDialog(
          ...
          pageBuilder: (BuildContext buildContext, Animation<double> animation,
            ...
            return RDConfirmDialog(
              title: _dialogTitle,
              content: _commonContent,
              buttonStyle: RDDialogButtonStyle.text,
            );
          },
        );
      },
    ...
    return RDButton(
      ...
      onTap: () {
        showGeneralDialog(
          ...
          pageBuilder: (BuildContext buildContext, Animation<double> animation,
              Animation<double> secondaryAnimation) {
            return RDAlertDialog.vertical(
                title: _dialogTitle,
                content: _commonContent,
                buttons: [
                  RDDialogButtonOptions(
                      title: '主要按钮',
                      action: () {
                  ...
                  RDDialogButtonOptions(
                      title: '次要按钮',
                      titleColor: RDTheme.of(context).brandColor7,
                      action: () {
                        Navigator.pop(context);
                      },
...
| height | double? | - | 按钮高度 |
| style | RDButtonStyle? | - | 按钮样式 |
| theme | RDButtonTheme? | - | 按钮类型 |
| title | String | - | 标题内容 |
| titleColor | Color? | - | 标题颜色 |
| titleSize | double? | - | 字体大小 |
| type | RDButtonType? | - | 按钮类型 |
...
| contentWidget | Widget? | - | 内容Widget |
| image | Image | - | 图片 |
| imagePosition | RDDialogImagePosition? | RDDialogImagePosition.top | 图片位置 |
| key |  | - |  |
| leftBtn | RDDialogButtonOptions? | - | 左侧按钮配置 |
...
| --- | --- | --- | --- |
| backgroundColor | Color? | - | 背景颜色 |
| buttonStyle |  | RDDialogButtonStyle.normal |  |
| buttonWidget | Widget? | - | 自定义按钮 |
| content | String? | - | 内容 |
| contentColor | Color? | - | 内容颜色 |
...
| 名称  | 说明 |
| --- |  --- |
| RDAlertDialog.vertical  | 纵向按钮排列的对话框

 [buttons]参数是必须的，纵向按钮默认样式都是[RDButtonTheme.primary] |
...
| action |  Function()? | - | 点击 |
| backgroundColor | Color? | - | 背景颜色 |
| buttonStyle | RDDialogButtonStyle | RDDialogButtonStyle.normal | 按钮样式 |
| buttonStyleCustom | RDButtonStyle? | - | 按钮自定义样式属性，背景色、边框... |
...
| --- | --- | --- | --- |
| key |  | - |  |
| leftBtn | RDDialogButtonOptions | - | 左按钮 |
| rightBtn | RDDialogButtonOptions | - | 右按钮 |
...
| 参数 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| buttonStyle | RDButtonStyle? | - | 按钮样式 |
| buttonText | String? | - | 按钮文字 |
| buttonTextColor | Color? | - | 按钮文字颜色 |
| buttonTextFontWeight | FontWeight? | FontWeight.w600 | 按钮文字粗细 |
| buttonTextSize | double? | - | 按钮文字大小 |
| buttonTheme | RDButtonTheme? | - | 按钮主题 |
| buttonType | RDButtonType? | - | 按钮类型 |
