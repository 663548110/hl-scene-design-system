...
[td_slider_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_slider_page.dart)
...
<td-code-block panel="Dart">
  ...
  Widget _buildCapsuleSingleHandleWithNumber(BuildContext context) {
    return RDSlider(
      sliderThemeData: RDSliderThemeData.capsule(
        context: context,
        showThumbValue: true,
        min: 0,
        max: 100,
    ...
    return RDSlider(
      sliderThemeData: RDSliderThemeData.capsule(
        ...
        scaleFormatter: (value) => value.toInt().toString(),
          ...
          // activeTickMarkColor: RDTheme.of(context).componentBorderColor,
          // inactiveTickMarkColor: RDTheme.of(context).componentStrokeColor,
          )),
      value: 60,
      onChanged: (value) {},
    );
    ...
    return RDRangeSlider(
      sliderThemeData: RDSliderThemeData.capsule(
        ...
        scaleFormatter: (value) => value.toInt().toString(),
          ...
          // activeTickMarkColor: RDTheme.of(context).bgColorComponent,
          // inactiveTickMarkColor: RDTheme.of(context).bgColorComponent,
          )),
      value: const RangeValues(20, 60),
      onChanged: (value) {},
    );
        ...
        RDSlider(
          sliderThemeData: RDSliderThemeData.capsule(
            ...
            scaleFormatter: (value) => value.toInt().toString(),
                ...
                activeTickMarkColor: RDTheme.of(context).componentStrokeColor,
                inactiveTickMarkColor: RDTheme.of(context).componentStrokeColor,
              )),
          value: 60,
        ),
        ...
        RDRangeSlider(
          sliderThemeData: RDSliderThemeData.capsule(
            ...
            scaleFormatter: (value) => value.toInt().toString(),
                ...
                activeTickMarkColor: RDTheme.of(context).bgColorComponentActive,
                inactiveTickMarkColor: RDTheme.of(context).bgColorComponent,
              )),
          value: const RangeValues(20, 60),
        )
...
| sliderThemeData | RDSliderThemeData? | - | 样式 |
