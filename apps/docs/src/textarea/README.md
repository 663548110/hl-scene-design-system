...
[td_textarea_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_textarea_page.dart)
  ...
  Widget _cardStyle(BuildContext context) {
    return RDTextarea(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
            BorderRadius.circular(RDTheme.of(context).radiusExtraLarge),
      ),
      margin: EdgeInsets.only(
          right: RDTheme.of(context).spacer16,
          left: RDTheme.of(context).spacer16),
      onChanged: (value) {},
    );
  }</pre>
...
| layout | RDTextareaLayout? | RDTextareaLayout.horizontal | 标题输入框布局方式。可选项：vertical/horizontal |
