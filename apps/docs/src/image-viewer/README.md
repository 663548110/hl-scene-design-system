...
[td_image_viewer_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_image_viewer_page.dart)
...
<td-code-block panel="Dart">
  ...
  Widget _basicImageViewer(BuildContext context) {
    return RDButton(
      ...
      text: '基础图片预览',
      onTap: () {
        RDImageViewer.showImageViewer(context: context, images: images);
      },
    );
  }</pre>
