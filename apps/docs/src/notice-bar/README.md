...
[td_notice-bar_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_notice-bar_page.dart)
...
Widget _iconNoticeBar(BuildContext context) {
  return const RDNoticeBar(
    content: '这是一条普通的通知信息',
    prefixIcon: RDIcons.error_circle_filled,
  );
}</pre>
...
Widget _entranceNoticeBar2(BuildContext context) {
  return const RDNoticeBar(
    content: '这是一条普通的通知信息',
    prefixIcon: RDIcons.error_circle_filled,
    suffixIcon: RDIcons.chevron_right,
  );
}</pre>
...
Widget _customNoticeBar(BuildContext context) {
  return RDNoticeBar(
    content: '这是一条普通的通知信息',
    prefixIcon: RDIcons.notification,
    suffixIcon: RDIcons.chevron_right,
    style:
        RDNoticeBarStyle(backgroundColor: RDTheme.of(context).bgColorComponent),
  );
}</pre>
...
Widget _successNoticeBar(BuildContext context) {
  return const RDNoticeBar(
    content: '这是一条成功的通知信息',
    prefixIcon: RDIcons.check_circle_filled,
    theme: RDNoticeBarTheme.success,
  );
}</pre>
...
Widget _warningNoticeBar(BuildContext context) {
  return const RDNoticeBar(
    content: '这是一条警示的通知信息',
    prefixIcon: RDIcons.error_circle_filled,
    theme: RDNoticeBarTheme.warning,
  );
}</pre>
...
Widget _cardNoticeBar(BuildContext context) {
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      color: RDNoticeBarStyle.generateTheme(context).backgroundColor,
...
| style | RDNoticeBarStyle? | - | 公告栏样式 [RDNoticeBarStyle] |
| suffixIcon | IconData? | - | 右侧图标 |
| theme | RDNoticeBarTheme? | RDNoticeBarTheme.info | 主题 |
...
| 名称  | 说明 |
| --- |  --- |
| RDNoticeBarStyle.generateTheme  | 根据主题生成样式 |
