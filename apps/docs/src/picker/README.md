...
[td_picker_page.dart](https://codeup.aliyun.com/656d6f743e469c2f3534a9ac/team3/flutter/rdesign-flutter-develop/blob/master/rdesign-component/example/lib/page/td_picker_page.dart)
...
<td-code-block panel="Dart">
  ...
  Widget buildMultiArea(BuildContext context) {
    ...
    return RDCell(
      ...
      arrow: true,
      onClick: (click) {
        RDPicker.showMultiLinkedPicker(
          context,
          title: title,
          onConfirm: (selected) {
            setState(() {
