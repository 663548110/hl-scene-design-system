...
code_binding:
  ...
  source_path: lib/src/components/tree
  usage_entry: lib/src/components/tree/rd_tree_select.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for tree
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for tree
```
