...
code_binding:
  ...
  source_path: lib/src/components/drawer
  usage_entry: lib/src/components/drawer/rd_drawer.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for drawer
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for drawer
```
...
- 公开导出文件：rd_drawer.dart, rd_drawer_widget.dart
