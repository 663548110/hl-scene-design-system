...
code_binding:
  ...
  source_path: lib/src/components/input
  usage_entry: lib/src/components/input/input_view.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for input
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for input
```
...
- 公开导出文件：input_view.dart, rd_input.dart, rd_input_spacer.dart
