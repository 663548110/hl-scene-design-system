...
```yaml
component:
  component_id: collapse
  semantic_name: Collapse
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/collapse
  usage_entry: lib/src/components/collapse/rd_collapse.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for collapse
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for collapse
```
...
- 公开导出文件：rd_collapse.dart, rd_collapse_panel.dart
