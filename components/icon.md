...
code_binding:
  ...
  source_path: lib/src/components/icon
  usage_entry: lib/src/components/icon/rd_icons.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for icon
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for icon
```
