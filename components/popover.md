...
code_binding:
  ...
  source_path: lib/src/components/popover
  usage_entry: lib/src/components/popover/rd_popover.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for popover
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for popover
```
...
- 公开导出文件：rd_popover.dart, rd_popover_widget.dart
