...
code_binding:
  ...
  source_path: lib/src/components/message
  usage_entry: lib/src/components/message/rd_message.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for message
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for message
```
