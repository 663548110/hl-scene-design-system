...
code_binding:
  ...
  source_path: lib/src/components/refresh
  usage_entry: lib/src/components/refresh/rd_refresh_header.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for refresh
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for refresh
```
