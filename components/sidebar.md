...
code_binding:
  ...
  source_path: lib/src/components/sidebar
  usage_entry: lib/src/components/sidebar/rd_sidebar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for sidebar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for sidebar
```
...
- 公开导出文件：rd_sidebar.dart, rd_sidebar_controller.dart, rd_sidebar_item.dart
