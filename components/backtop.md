...
```yaml
component:
  component_id: backtop
  semantic_name: Backtop
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/backtop
  usage_entry: lib/src/components/backtop/rd_backtop.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for backtop
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for backtop
```
