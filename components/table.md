...
code_binding:
  ...
  source_path: lib/src/components/table
  usage_entry: lib/src/components/table/rd_table.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for table
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for table
```
...
- 公开导出文件：rd_table.dart, rd_table_col.dart, rd_table_empty.dart
