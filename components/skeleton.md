...
code_binding:
  ...
  source_path: lib/src/components/skeleton
  usage_entry: lib/src/components/skeleton/rd_skeleton.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for skeleton
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for skeleton
```
...
- 公开导出文件：rd_skeleton.dart, rd_skeleton_rowcol.dart
