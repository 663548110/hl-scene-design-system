...
code_binding:
  ...
  source_path: lib/src/components/radio
  usage_entry: lib/src/components/radio/rd_radio.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for radio
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for radio
```
