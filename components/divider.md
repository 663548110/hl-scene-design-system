...
code_binding:
  ...
  source_path: lib/src/components/divider
  usage_entry: lib/src/components/divider/rd_divider.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for divider
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for divider
```
