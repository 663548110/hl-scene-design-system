...
code_binding:
  ...
  source_path: lib/src/components/toast
  usage_entry: lib/src/components/toast/rd_toast.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for toast
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for toast
```
