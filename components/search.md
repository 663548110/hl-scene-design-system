...
code_binding:
  ...
  source_path: lib/src/components/search
  usage_entry: lib/src/components/search/rd_search_bar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for search
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for search
```
