...
```yaml
component:
  component_id: time_counter
  semantic_name: Time Counter
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/time_counter
  usage_entry: lib/src/components/time_counter/rd_time_counter.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for time_counter
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for time_counter
```
...
- 公开导出文件：rd_time_counter.dart, rd_time_counter_controller.dart, rd_time_counter_style.dart
