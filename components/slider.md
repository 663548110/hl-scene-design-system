...
code_binding:
  ...
  source_path: lib/src/components/slider
  usage_entry: lib/src/components/slider/rd_slider.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for slider
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for slider
```
...
- 公开导出文件：rd_slider.dart, rd_slider_theme.dart
