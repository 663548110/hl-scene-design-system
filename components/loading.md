...
code_binding:
  ...
  source_path: lib/src/components/loading
  usage_entry: lib/src/components/loading/rd_circle_indicator.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for loading
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for loading
```
...
- 公开导出文件：rd_circle_indicator.dart, rd_loading.dart, rd_loading_controller.dart
