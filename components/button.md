...
code_binding:
  ...
  source_path: lib/src/components/button
  usage_entry: lib/src/components/button/rd_button.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for button
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for button
```
...
- 公开导出文件：rd_button.dart, rd_button_style.dart
