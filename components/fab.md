...
code_binding:
  ...
  source_path: lib/src/components/fab
  usage_entry: lib/src/components/fab/rd_fab.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for fab
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for fab
```
