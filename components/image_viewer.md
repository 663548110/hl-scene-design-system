...
```yaml
component:
  component_id: image_viewer
  semantic_name: Image Viewer
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/image_viewer
  usage_entry: lib/src/components/image_viewer/rd_image_viewer.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for image_viewer
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for image_viewer
```
...
- 公开导出文件：rd_image_viewer.dart, rd_image_viewer_widget.dart
