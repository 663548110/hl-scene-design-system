...
code_binding:
  ...
  source_path: lib/src/components/dropdown_menu
  usage_entry: lib/src/components/dropdown_menu/rd_dropdown_item.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for dropdown_menu
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for dropdown_menu
```
...
- 公开导出文件：rd_dropdown_item.dart, rd_dropdown_menu.dart
