...
code_binding:
  ...
  source_path: lib/src/components/image
  usage_entry: lib/src/components/image/image_widget.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for image
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for image
```
...
- 公开导出文件：image_widget.dart, rd_image.dart
