...
code_binding:
  ...
  source_path: lib/src/components/checkbox
  usage_entry: lib/src/components/checkbox/rd_check_box.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for checkbox
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for checkbox
```
...
- 公开导出文件：rd_check_box.dart, rd_check_box_group.dart
