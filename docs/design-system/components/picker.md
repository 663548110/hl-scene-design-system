...
code_binding:
  ...
  source_path: lib/src/components/picker
  usage_entry: lib/src/components/picker/rd_date_picker.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for picker
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for picker
```
...
- 公开导出文件：rd_date_picker.dart, rd_item_widget.dart, rd_multi_picker.dart, rd_picker.dart
