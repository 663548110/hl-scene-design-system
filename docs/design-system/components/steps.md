...
code_binding:
  ...
  source_path: lib/src/components/steps
  usage_entry: lib/src/components/steps/rd_steps.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for steps
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for steps
```
