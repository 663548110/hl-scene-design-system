...
code_binding:
  ...
  source_path: lib/src/components/footer
  usage_entry: lib/src/components/footer/rd_footer.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for footer
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for footer
```
