...
code_binding:
  ...
  source_path: lib/src/components/link
  usage_entry: lib/src/components/link/rd_link.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for link
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for link
```
