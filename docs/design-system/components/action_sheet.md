...
```yaml
component:
  component_id: action_sheet
  semantic_name: Action Sheet
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/action_sheet
  usage_entry: lib/src/components/action_sheet/rd_action_sheet.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for action_sheet
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for action_sheet
```
