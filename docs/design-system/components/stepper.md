...
code_binding:
  ...
  source_path: lib/src/components/stepper
  usage_entry: lib/src/components/stepper/rd_stepper.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for stepper
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for stepper
```
