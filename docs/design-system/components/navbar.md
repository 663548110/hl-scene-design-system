...
code_binding:
  ...
  source_path: lib/src/components/navbar
  usage_entry: lib/src/components/navbar/rd_nav_bar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for navbar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for navbar
```
