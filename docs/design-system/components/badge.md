...
code_binding:
  ...
  source_path: lib/src/components/badge
  usage_entry: lib/src/components/badge/rd_badge.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for badge
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for badge
```
