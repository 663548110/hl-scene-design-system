...
code_binding:
  ...
  source_path: lib/src/components/upload
  usage_entry: lib/src/components/upload/rd_upload.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for upload
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for upload
```
