...
code_binding:
  ...
  source_path: lib/src/components/cell
  usage_entry: lib/src/components/cell/rd_cell.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for cell
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for cell
```
...
- 公开导出文件：rd_cell.dart, rd_cell_group.dart, rd_cell_style.dart
