...
code_binding:
  ...
  source_path: lib/src/components/tabbar
  usage_entry: lib/src/components/tabbar/rd_bottom_tab_bar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for tabbar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for tabbar
```
