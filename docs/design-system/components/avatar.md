...
code_binding:
  ...
  source_path: lib/src/components/avatar
  usage_entry: lib/src/components/avatar/rd_avatar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for avatar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for avatar
```
