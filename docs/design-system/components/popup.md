...
code_binding:
  ...
  source_path: lib/src/components/popup
  usage_entry: lib/src/components/popup/rd_popup_panel.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for popup
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for popup
```
...
- 公开导出文件：rd_popup_panel.dart, rd_popup_route.dart
