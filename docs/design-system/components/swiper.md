...
code_binding:
  ...
  source_path: lib/src/components/swiper
  usage_entry: lib/src/components/swiper/rd_page_transform.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for swiper
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for swiper
```
...
- 公开导出文件：rd_page_transform.dart, rd_swiper.dart
