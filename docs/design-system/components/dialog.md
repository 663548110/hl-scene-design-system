...
code_binding:
  ...
  source_path: lib/src/components/dialog
  usage_entry: lib/src/components/dialog/rd_dialog.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for dialog
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for dialog
```
