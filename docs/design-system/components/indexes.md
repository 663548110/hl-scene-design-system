...
code_binding:
  ...
  source_path: lib/src/components/indexes
  usage_entry: lib/src/components/indexes/rd_indexes.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for indexes
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for indexes
```
