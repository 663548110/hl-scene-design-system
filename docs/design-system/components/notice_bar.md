...
```yaml
component:
  component_id: notice_bar
  semantic_name: Notice Bar
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/notice_bar
  usage_entry: lib/src/components/notice_bar/rd_notice_bar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for notice_bar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for notice_bar
```
...
- 公开导出文件：rd_notice_bar.dart, rd_notice_bar_style.dart
