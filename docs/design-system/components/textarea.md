...
code_binding:
  ...
  source_path: lib/src/components/textarea
  usage_entry: lib/src/components/textarea/rd_textarea.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for textarea
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for textarea
```
