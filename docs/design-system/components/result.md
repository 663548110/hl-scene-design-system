...
code_binding:
  ...
  source_path: lib/src/components/result
  usage_entry: lib/src/components/result/rd_result.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for result
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for result
```
