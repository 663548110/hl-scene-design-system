...
```yaml
component:
  component_id: cascader
  semantic_name: Cascader
  status: placeholder
  owners: []
  consumer_role_ids:
    - design_side
...
code_binding:
  ...
  source_path: lib/src/components/cascader
  usage_entry: lib/src/components/cascader/rd_cascader.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for cascader
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for cascader
```
...
- 公开导出文件：rd_cascader.dart, rd_cascader_action.dart, rd_custom_tab.dart, rd_multi_cascader.dart
