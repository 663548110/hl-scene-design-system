...
code_binding:
  ...
  source_path: lib/src/components/text
  usage_entry: lib/src/components/text/rd_font_loader.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for text
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for text
```
...
- 公开导出文件：rd_font_loader.dart, rd_text.dart
