...
code_binding:
  ...
  source_path: lib/src/components/empty
  usage_entry: lib/src/components/empty/rd_empty.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for empty
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for empty
```
