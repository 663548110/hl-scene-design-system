...
code_binding:
  ...
  source_path: lib/src/components/progress
  usage_entry: lib/src/components/progress/rd_progress.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for progress
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for progress
```
