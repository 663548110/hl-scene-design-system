...
code_binding:
  ...
  source_path: lib/src/components/calendar
  usage_entry: lib/src/components/calendar/rd_calendar.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for calendar
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for calendar
```
