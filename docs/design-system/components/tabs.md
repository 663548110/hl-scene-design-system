...
code_binding:
  ...
  source_path: lib/src/components/tabs
  usage_entry: lib/src/components/tabs/rd_tab.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for tabs
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for tabs
```
...
- 公开导出文件：rd_tab.dart, rd_tab_bar.dart, rd_tab_bar_view.dart
