...
code_binding:
  ...
  source_path: lib/src/components/rate
  usage_entry: lib/src/components/rate/rd_rate.dart
```
...
code_snippets:
  - snippet_id: minimal
    ...
    code: |
      // TODO: add minimal usage snippet for rate
  - snippet_id: composition
    ...
    code: |
      // TODO: add composition usage snippet for rate
```
