...
import 'page/rd_biz_components_page.dart';
import 'page/rd_datetime_picker_page.dart';
import 'page/rd_theme_page.dart';
...
Map<String, List<ExamplePageModel>> exampleMap = {
  ...
  '主题': [
    ExamplePageModel(
        text: 'RD 多项目主题',
        name: 'rd_theme',
        pageBuilder: _wrapInheritedTheme((context) => const RDThemePage())),
    ExamplePageModel(
        text: 'RD 业务组件',
        name: 'rd_biz',
        pageBuilder: _wrapInheritedTheme((context) => const RDBizComponentsPage())),
    ExamplePageModel(
        text: 'RD 日期时间选择器',
        name: 'rd_datetime_picker',
        pageBuilder: _wrapInheritedTheme((context) => const RDDatetimePickerPage())),
    ExamplePageModel(
        text: '颜色',
        name: 'theme_colors',
        pageBuilder:
